...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iscan-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10429&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iscan-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iscan` can be installed with:

```
conda install iscan
```

It is possible to list all of the versions of `iscan` available on your platform with:
